                ...
                echo "<table class='table table-bordered table-striped'>";
                    ...
                    while($i<count($allapps)){
                        echo "<tr>";
                           ...
                           $strconfirmed=$conf;
                           $strtotalcost=$allapps[$i]->final_cost;
                           $strpyam=$allapps[$i]->payedamount;
                            ...
                            $ecrypt_1=(($strid*123456789*5678)/956783);
                            $ecrypt_2=urldecode(base64_encode($ecrypt_1));
                        ...
                        echo "<form action='/test/controller/apptestdetailcontroller.php' method='get'>";  
                        echo "<a href='/test/controller/apptestdetailcontroller.php?id=$ecrypt_2&type=submit' name='addmeasure' title='addmeasure' data-toggle='tooltip'>see details </a>";
                        echo"</form>";
    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class='page-header clearfix'>
                <h2 class='pull-left'>waiting Appointments</h2>
                <form action='/test/controller/showappcontroller.php' method='post'>;    
